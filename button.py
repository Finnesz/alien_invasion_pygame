...
class Button:
    def __init__(self, ai_game, msg, x, y):
        ...
        self.font = pygame.font.SysFont("Noto Sans", 48)
...
class TButton(Button):
    """Button with texture"""
    def __init__(self, ai_game, msg, img_dir, x, y):
        self.width, self.height = 200, 50
        ...
        self.texture_rect.x = x
        self.texture_rect.y = y

        super().__init__(ai_game, msg, x, y) # had to put it here because Button class's _prep_msg does not recognize texture when initialized
...
# TODO: Do this some other time lol
class Arrow():
    """Arrows to show which button is being hovered by the mouse."""
    def __init__(self):
        pass
